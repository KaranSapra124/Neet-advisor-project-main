    ...
    <Container className={"relative bg-webinar-hero"}>
      ...
      <ScrollAnimation animateIn="backInRight" duration={1.5}>
        <div className="relative z-50 mx-auto">
          ...
          <p className="text-gray-700 font-semibold text-center text-xs my-2  ">Guiding you towards your dream career with personalized advice, expert guidance, and a clear roadmap to success.</p>
