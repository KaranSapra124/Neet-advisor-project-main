        ...
        <div className="container mx-auto px-4 ">
            ...
            <div className="text-center mb-16 space-y-4">
                <h1 className="text-4xl text-primary-color font-bold tracking-tight">
                    Seminar And <span className="text-yellow-500 italic font-extrabold">Workshops</span>
                </h1>
                <div className="w-24 h-1 bg-yellow-500 mx-auto rounded-full"></div>
                <p className='text-gray-700 font-semibold text-sm whitespace-pre-wrap'>Through dedication and innovation, we have successfully hosted impactful seminars and workshops, <br /> setting new standards of excellence in education and professional development.</p>
            </div>
