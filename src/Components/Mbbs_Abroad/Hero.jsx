...
const Hero = () => {
  ...
  const features = [
    {
      icon: <FaGlobeAmericas className="h-6 w-6 mx-auto text-white" />,
      text: "International Education",
    },
    { icon: <FaBookReader className="h-6 w-6 mx-auto text-white" />, text: "Expert Counselling" },
    { icon: <FaUserGraduate className="h-6 w-6 mx-auto text-white" />, text: "Career Guidance" },
  ];
      ...
      <Container className={"relative h-screen"}>
        ...
        <div className="flex h-full items-center">
          <div className="relative flex h-fit w-fit flex-col justify-center gap-5 rounded-md bg-white/35 p-4 shadow-sm shadow-white backdrop-blur-sm">
            ...
            <p className="max-w-screen-sm text-justify text-sm font-semibold text-gray-200">
              ...
              competitive edge in your medical career. Affordable tuition fees,
              diverse cultures, and international recognition of degrees make
              studying MBBS abroad a smart choice for aspiring doctors. Embark
              on this journey to turn your medical aspirations into reality!
            </p>
            <div className="flex justify-start">
              ...
              <button className="text-md mx-2 rounded-l-full rounded-r-full border-2 border-gray-200 px-2 py-1 font-bold uppercase text-gray-200 hover:scale-110  transition-all duration-200 hover:border-none hover:bg-black hover:text-white">
                Learn More
              </button>
            </div>
          </div>
          <div className="absolute left-[20.5rem] top-[32rem] flex gap-2">
            ...
            >
              {features?.map((elem, index) => {
                return (
                  <div className="flex text-center h-20 w-32 flex-col items-center justify-center space-y-4 rounded-md border-2 border-white bg-black/30 p-2 shadow-md">
