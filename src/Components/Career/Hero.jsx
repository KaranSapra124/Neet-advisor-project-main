  ...
  return (
    <>
      <Container className={"relative h-screen"}>
        ...
        ></video>
        <div className="absolute inset-0 h-full w-full  bg-gradient-to-tr from-black/90  to-black/80"></div>
        <div className="relative inset-0 mx-auto flex  h-full  flex-col items-center justify-center gap-5">
          <div className="flex items-center justify-center">
            {" "}
            <h1 className="text-4xl font-bold text-primary-color brightness-200">
              Join Our Team At
            </h1>
          ...
          <p className="max-w-screen-sm text-center text-xs font-semibold text-gray-300">
            Are you passionate about education and helping students achieve
            their dreams? At <strong>Neet Advisor!</strong>, we are on a mission
            to guide aspiring medical students through their{" "}
          ...
          <button className="my-4 rounded-l-full rounded-r-full bg-yellow-600 px-2 py-1 text-sm font-extrabold text-white transition-all duration-200 hover:bg-yellow-700">
            View Openings
          </button>
        </div>
