...
const Values = () => {
    const data = [
        {
            label: <div className='w-full h-full flex  justify-center items-center my-20'><h1 className='text-3xl text-primary-color font-bold mt-2 flex items-center animate-pulse'>For Parents<span><FaArrowRight className='text-yellow-600 mx-2' /></span></h1></div>,
            color: "#201169",
            children: <>
                <ScrollAnimation animateIn='backInRight' duration={1.5} animateOnce animatePreScroll>

                    <div className='border max-w-screen-sm p-2 rounded-lg  m-4 shadow-md bg-white'>
                        <Badge className='bg-yellow-600 text-xs p-2 rounded-md text-white font-bold'>Mandatory</Badge>
                        ...
                        <div className='flex max-[600px]:flex-wrap mt-2'>
                            <video className='w-64 ' autoPlay loop>
        ...
        {
            color: "#201169",
            label: <div className='w-full h-full flex  justify-center items-center my-20'><h1 className='text-3xl text-primary-color font-bold mt-2 flex justify-center items-center flex-row-reverse animate-pulse '>For Students <span><FaArrowLeft className='text-yellow-600 mx-2' /></span> </h1></div>,
            children: <>
                <ScrollAnimation animateIn='backInLeft' animateOnce duration={1.5} animatePreScroll>

                    <div className='text-start border p-2 rounded-lg m-2 max-w-screen-sm shadow-md bg-white'>
                        <Badge className='bg-yellow-600 text-xs p-2 rounded-md text-white font-bold mb-2'>Mandatory</Badge>
                        ...
                        <div className='flex mt-2 max-[600px]:flex-wrap'>
                            <video className='w-64  ' autoPlay loop>
                                <source src="https://videos.pexels.com/video-files/6209572/6209572-sd_960_506_25fps.mp4" type="video/mp4" />
                                Your browser does not support the video tag.
                            </video>
                            <ul className='ml-1 !font-normal '>
                                <li className='flex items-center text-xs mt-2'>
                                ...
                                <li className='flex items-center text-xs mt-1'>
                                    <TiTick className='text-green-500 text-4xl' />
    ...
    return (
        <Container className={"bg-gray-200/40"}>
            <div >
                <h1 className='text-center text-primary-color text-3xl font-bold'>Who Is This Webinar <span className='text-yellow-600 font-extrabold'>For ?</span></h1>
            </div>
            <div className='mt-10'>
