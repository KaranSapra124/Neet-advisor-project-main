...
function Navbar() {
  ...
  return (
    <nav
      className={` ${window.location.pathname.includes("medical-expo") || window.location.pathname.includes("careers") || window.location.pathname.includes("ug-seminar") || window.location.pathname.includes("pg-seminar") || window.location.pathname.includes("mbbs-abroad") ? "bg-gradient-to-br from-black/80 via-gray-900 to-gray-900/80" : window.location.pathname.includes("gallery") ? "bg-gradient-to-r from-gray-900/30 via-primary-color/45 to-gray-800/20" : "bg-white"} sticky top-0 z-[1000] p-4 px-20 shadow-lg backdrop-blur-sm`}
    >
