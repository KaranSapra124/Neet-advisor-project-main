...
function Navbar() {
  ...
  return (
    <nav
      className={` ${window.location.pathname.includes("medical-expo") || window.location.pathname.includes("ug-seminar")  ? "bg-gradient-to-br from-black to-black/85" : "bg-white"} sticky top-0 z-[1000] p-4 px-20 shadow-lg backdrop-blur-sm`}
    >
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:block">
          <ul className="flex space-x-6">
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    isActive
                      ...
                      : `transition-all hover:scale-105 hover:font-bold ${window.location.pathname.includes("medical-expo") ? "text-white" : "text-gray-600"}`
                  }
                  to={elem?.link}
                >
                  {elem?.title}{" "}
            ...
            <Dropdown
              className={`cursor-pointer ${window.location.pathname.includes("medical-expo") ? "text-white" : "text-gray-600"}`}
              overlay={menu}
              arrow
              placement="bottom"
            >
