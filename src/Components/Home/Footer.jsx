...
const Footer = () => {
  return (
    <footer
      className={`${window.location.pathname.includes("medical-expo") || window.location.pathname.includes("mbbs-abroad") || window.location.pathname.includes("careers") || window.location.pathname.includes("ug-seminar") || window.location.pathname.includes("pg-seminar") ? "bg-gradient-to-tr from-black/80 via-gray-900 to-gray-900/80" : window.location.pathname.includes("gallery") ? "bg-gradient-to-tr from-gray-900/30 via-primary-color/45 to-gray-800/20" : "bg-primary-color"} p-20 text-white`}
    >
