    ...
    <>
      <Container className={"bg-gray-200/40"}>
        <div className="mx-5 flex flex-col text-center">
          <h1 className="text-md text-center font-bold text-yellow-600 lg:text-3xl">
            Get the{" "}
        ...
        <ScrollAnimation animateIn="backInUp" animateOnce={true} duration={1.5}>
          <Carousel
            ...
            dots={false}
            className="w-full gap-x-1 lg:mx-10 lg:my-5"
            arrows={true}
            dotPosition="bottom"
            infinite
            autoplay
                      ...
                      <div className="flex h-16 items-center justify-center p-2">
                        <h4
                          dangerouslySetInnerHTML={{
                            __html: elem?.generatedHTML?.substring(0, 130),
                          }}
                          className="text-wrap line-clamp-2 text-justify text-[0.5rem] text-gray-700 lg:text-[0.7rem]"
                        ></h4>
          ...
          <button
            ...
            className="m-auto flex items-center justify-center rounded-md bg-yellow-600 p-2 text-[0.5rem] font-extrabold text-white duration-200 hover:scale-105 hover:bg-yellow-500 lg:text-sm lg:font-semibold"
          >
            View More{" "}
            <span>
