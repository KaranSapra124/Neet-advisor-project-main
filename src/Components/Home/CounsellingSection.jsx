...
const CounsellingSection = () => {
    ...
    return (
        <>
            <div className='bg-yellow-100/20 bg-fixed   p-20' >
                <div className="text-center mb-10">
                    ...
                    <p className="text-md text-gray-600 gabriela-regular">Get personalized answers and ease your biggest doubts with Video Counselling from our curated experts.</p>
                </div>
                <div className='flex flex-wrap justify-between gap-x-2'>
                    {counselingVideos?.map((elem, index) => {
                        return (
                                    ...
                                    <>
                                        <div className="h-fit   flex max-[600px]:flex-col p-4 bg-gray-100 rounded-lg shadow-xl">
                                            ...
                                            <div className="w-full  space-y-2 p-2 mx-2 bg-white   rounded-md shadow-lg ">
                                                <h3 className="text-md font-semibold text-gray-800 ">Key Points:</h3>
                            ...
                            >
                                <button className="relative inline-block text-md font-semibold p-2 px-8 bg-white text-black hover:text-white  z-[999] rounded-lg shadow-xl overflow-hidden cursor-pointer transition-all hover:scale-105 group">
                                    <span className="relative z-[1000] hover:font-extrabold text-xs">{elem.title}</span>
