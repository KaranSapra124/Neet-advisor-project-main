                ...
                <div className=" mx-auto  bg-yellow-100/20">
                    ...
                    <div className="text-center my-4">
                        <h1 className="text-3xl md:text-4xl font-bold primary mb-4">
                            On your marks , get set , <span className="text-yellow-600 font-extrabold">Enroll!</span>
                        </h1>
                        <p className="text-gray-700 font-semibold text-xs mx-auto">
                    ...
                    <ScrollAnimation animateIn='backInUp' duration={2} animateOnce={true}>
                        ...
                        <div className="grid cursor-pointer grid-cols-1 md:grid-cols-2 gap-1 w-[68rem] mx-auto">
                                    ...
                                    <div className="flex flex-col md:flex-row ">
                                        ...
                                        <div className="flex-1 ml-2">
                                            <div className="flex items-center gap-2  mb-3">
                                                {service.icon}
                                                <span className="text-sm font-bold text-primary-color">{service.title}</span>
                                            </div>

                                            <div className={`transition-all md:w-full  duration-500 overflow-hidden ${expandedCards[index] ? 'max-h-96' : 'max-h-20'}`}>
                                                <p className="text-gray-900 mb-4 text-xs font-semibold">{service.content}</p>
                                                <p className="text-gray-900 text-xs font-semibold">{service.extendedContent}</p>
                                            </div>

                                            <button className='transition-all duration-300 py-2 shadow p-2 bg-yellow-600 text-white font-semibold rounded-lg mt-2 text-xs' onClick={() => toggleExpand(index)}>
