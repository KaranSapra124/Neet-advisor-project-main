...
const EventLocation = () => {
    return (
        <Container className={'bg-gradient-to-br from-black to-black/85 flex flex-col justify-center items-center '}>
            ...
            <p className='text-gray-200 text-center my-4 w-64 font-semibold text-xs'>Contact us for more details on the Medical Advisor Expo</p>
            <div className='flex  justify-center items-center'>
                <div className='flex flex-col justify-center items-center'>
                    <div className='flex'>
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3505.0180566231634!2d77.2802189754974!3d28.539176975715858!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce386847e1c93%3A0x535231df782a3e3d!2sNEET%20ADVISOR!5e0!3m2!1sen!2sin!4v1736235673499!5m2!1sen!2sin" className='rounded-lg border-none  hover:scale-105 transition-all cursor-pointer w-[26rem]' allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        <img className='w-[26rem] mx-5 hover:scale-105 transition-all cursor-pointer' src="https://neetadvisor.com/assets/images/1-(1).webp" alt="" />
                    </div>
                </div>
                <EventDetails />
            </div>
