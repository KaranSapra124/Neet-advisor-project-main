        ...
        >
          <div className="relative">
            <div className="text-center">
              <h1 className="my-2 text-sm lg:text-3xl font-bold text-yellow-600">
                Insightful{" "}
                <span className="font-extrabold text-primary-color brightness-200">
                  Voices!
                </span>
              </h1>
              <p className="my-2 lg:text-xs text-[0.5rem] font-semibold text-gray-200">
            ...
            <div className="mx-auto flex lg:max-w-screen-xl  justify-center lg:gap-4 gap-2 lg:flex-row flex-col">
